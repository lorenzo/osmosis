...
-- 
-- Host: localhost
-- Generation Time: Oct 19, 2007 at 10:10 AM
...
CREATE TABLE `control_modes` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='ControlMode: contenedor de información del sequencing' AUTO_INCREMENT=3 ;
...
CREATE TABLE `scorms` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Represents a scorm asset in a course' AUTO_INCREMENT=3 ;
