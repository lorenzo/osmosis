...
class LatexRender {
    ...
    function renderLatex($latex_formula) {
        ...
        $command = $this->_dvips_path." ".$this->_tmp_filename.".dvi";
        $status_code = exec($command);

        // imagemagick convert ps to image and trim picture
        $command = $this->_convert_path." ".$this->_tmp_filename.".ps  -density ".$this->_formula_density.
