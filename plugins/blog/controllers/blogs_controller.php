...
class BlogsController extends BlogAppController {
	...
	function add() {
		if (!empty($this->data)) {
			...
			if ($this->Blog->save($this->data)) {
				$this->Session->setFlash(__d('blog','The Blog has been saved',true), 'default', array('class' => 'success'));
				$this->redirect(array('action'=>'index'));
			} else {
				$this->Session->setFlash(__d('blog','The Blog could not be saved. Please, try again.',true), 'default', array('class' => 'error'));
			}
		}
	}
	...
	function delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__d('blog','Invalid id for Blog',true), 'default', array('class' => 'error'));
			$this->redirect(array('action'=>'index'));
		}
		if ($this->Blog->del($id)) {
			$this->Session->setFlash(__d('blog','Blog deleted',true), 'default', array('class' => 'success'));
			$this->redirect(array('action'=>'index'));
		}
